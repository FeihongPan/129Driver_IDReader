...
void IFileOperator::SetCRCVerifyUsed(bool used)
{
    this->m_bCRCVerifyUsed = used;
}

void IFileOperator::SetPath(const QString &folderPath, const QString &folderPath_Backup, const QString &fileName, const QString &cmdPath)
{
...
void IFileOperator::SetFolderPath(const QString &folderPath)
{
    this->m_FolderPath = folderPath;
}

void IFileOperator::SetFileName(const QString &fileName)
{
    this->m_FileName = fileName;
}

void IFileOperator::SetFolderPath_CmdSample(const QString &folderPath)
{
...
QString IFileOperator::FileOperatorName()
{
    return this->m_Name;
}
